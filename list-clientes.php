  ...
  <div class="row">
    ...
    <section class="col s9 contenido">
      ...
      <div class="titulo-tabla">
	    ...
	    <div class="opciones">
	        <a href="add-clientes.php"><i class="zoom icon-user-plus" title="Añadir cliente"></i></a>
	        
	        <a href="clientes-pdf.php" target="_blank"><i class="icon-file-pdf" title="Descargar PDF" ></i></a>
	    </div>
