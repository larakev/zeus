  ...
  <div class="row">
    ...
    <section class="col s9 contenido">
      ...
      <div class="titulo-tabla">
        ...
        <div class="opciones">
            <i class="icon-user-plus" onclick="location.href='add-productos.php'" title="Añadir cliente"></i>
           
            <a href="productos-pdf.php" target="_blank"><i class="icon-file-pdf" title="Descargar PDF"></i></a>
        </div>
