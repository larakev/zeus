        ...
        <div class="row">
          ...
          <form action="" method="POST" name="Form" class="col s12">
            ...
            <div class="row">
              ...
              <button class="btn waves-effect waves-light" type="submit" name="submit">Añadir
  ...
  include 'db.php';
    ...
    if(isset($_POST['submit'])){
      if (isset($tipo) && !empty($tipo) &&
          ...
          $sql=("INSERT INTO productos(tipo,marca,modelo,nserial,precio,existencias,descripcion)VALUES('$tipo','$marca','$modelo','$nserial','$precio','$existencias','$descripcion')");
